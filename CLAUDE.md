...
- **Status**: Phase 97 complete + Phase T133 + Phase R113 — ML-KEM poly + SM9 Fp12 + encrypted PKCS#8 deepening + dev profile opt-level=2 (3124 tests, 7 ignored)
...
│   ├── hitls-crypto/    # Cryptographic algorithms (feature-gated): AES, SM4, ChaCha20, SHA-2/3, SM3, HMAC, RSA, ECC, Ed25519/448, X25519/448, DH, DSA, SM2, SM9, PQC (ML-KEM/ML-DSA/SLH-DSA/XMSS/FrodoKEM/McEliece), DRBG, FIPS/CMVP, entropy health, hardware AES/SHA-2/GHASH/ChaCha20, P-256 fast path (979 tests + 15 Wycheproof, 2 ignored)
...
│   ├── hitls-pki/       # X.509, PKCS#8 (incl. Encrypted PBES2), PKCS#12, CMS (SignedData/EnvelopedData/EncryptedData/DigestedData/AuthenticatedData), hostname verification (380 tests)
...
# Run all tests (3124 tests, 7 ignored)
cargo test --workspace --all-features

# Run tests for a specific crate
cargo test -p hitls-crypto --all-features   # 979 tests (2 ignored) + 15 Wycheproof
cargo test -p hitls-tls --all-features      # 1290 tests

cargo test -p hitls-pki --all-features      # 380 tests
