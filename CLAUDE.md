...
- **Status**: Phase 92 complete + Phase T106 — DTLS loss simulation & resilience tests (2634 tests)
...
│   ├── hitls-tls/       # TLS 1.3/1.2 (91 cipher suites), DTLS 1.2, TLCP, DTLCP; 10 connection types (5 sync + 5 async via tokio); 15 TLS extensions; 10 callbacks; session cache, hostname verification, renegotiation, GREASE, custom extensions, NSS key logging (1193 tests)
...
├── tests/interop/       # Integration tests (145 cross-crate tests, 3 ignored) — 12 test files + helper lib
...
# Run all tests (2634 tests, 40 ignored)
...
cargo test -p hitls-integration-tests       # 145 tests (3 ignored)
...
Phase 0–92 complete + Phase T73–T106 + Phase R102–R111 (2634 tests, 40 ignored). **100% C→Rust feature parity achieved. Architecture refactoring complete.**
