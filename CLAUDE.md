...
- **Status**: Phase 97 complete + Phase T130 — FrodoKEM PKE + SM9 G1 point + SM9 Fp deepening (3079 tests, 22 ignored)
...
│   ├── hitls-crypto/    # Cryptographic algorithms (feature-gated): AES, SM4, ChaCha20, SHA-2/3, SM3, HMAC, RSA, ECC, Ed25519/448, X25519/448, DH, DSA, SM2, SM9, PQC (ML-KEM/ML-DSA/SLH-DSA/XMSS/FrodoKEM/McEliece), DRBG, FIPS/CMVP, entropy health, hardware AES/SHA-2/GHASH/ChaCha20, P-256 fast path (939 tests + 15 Wycheproof, 17 ignored)
...
# Run all tests (3079 tests, 22 ignored)
cargo test --workspace --all-features

# Run tests for a specific crate
cargo test -p hitls-crypto --all-features   # 939 tests (17 ignored) + 15 Wycheproof
