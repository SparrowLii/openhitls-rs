...
| **L2** | Unit Tests | 3,094 tests (22 ignored), 100% pass rate | Comprehensive |
...
| hitls-crypto | 949 | 17 | 30.6% | 48 algorithm modules + hardware acceleration (AES/SHA-2/GHASH/ChaCha20) + P-256 fast path + proptest |
